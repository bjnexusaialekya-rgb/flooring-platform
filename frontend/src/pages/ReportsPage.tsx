...
// Rotating palette for the "Top Properties" bars — reuses colors already
// established elsewhere in the app (plum, revenue chip, status-approved,
// amber, status-scheduled) rather than introducing new ones, so a 6th+
// property just wraps back to plum instead of running out of colors.
const PROPERTY_BAR_COLORS = [
  'var(--color-plum)',
  'var(--color-chip-revenue)',
  'var(--color-amber)',
  'var(--color-link)',
